...
describe('ArrowsComponent', () => {
    ...
    beforeEach(testing_1.async(() => {
        testing_1.TestBed.configureTestingModule({
            declarations: [_1.CarouselArrowsComponent],
            schemas: [core_1.CUSTOM_ELEMENTS_SCHEMA]
        })
            .compileComponents();
    }));
    beforeEach(() => {
        fixture = testing_1.TestBed.createComponent(_1.CarouselArrowsComponent);
...
//# sourceMappingURL=arrows.component.spec.js.map